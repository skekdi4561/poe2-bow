...
THRESHOLDS = [400, 450, 500, 505, 510, 515, 520, 540, 560, 580, 600, 610, 620, 640,
              660, 690, 720, 750, 780]
# 505~520 이 촘촘한 이유: 실측에서 501 DPS 5카오스 -> 533 DPS 1디바인(=300엑잘) 으로
# 절벽이 바로 이 사이에 있었다. 절벽 위치를 1~2 DPS 단위로 짚어야 살지 말지가 갈린다.
# 660~780 상단 확장(사용자 분업 결정): 낮은 가격/저-DPS 는 사용자들의 가격검색이
# 크라우드로 채우고, 고-DPS 끝단(비싸서 아무도 가격검색 안 하는 구간)은 우리 수집기가
# 전담한다. 실측상 DPS>=660 에 125개가 몰려 660 한 밴드(가격 오름차순 100개)로는 비싼
# 고-DPS 매물이 잘렸다 — 690/720/750/780 을 추가하면 각 층이 100개 미만이라 통째로 잡힌다.
